...
button_info = [
    ...
    ('Ticket recommendor', budget_game, 185, 140, 'See what your budget gets you!'),
    ...
    ('Dice Guessing Game', dice_game, 185, 280, 'Play a dice game!'),
    ...
    ('Hangman Game', hangman, 335, 350, 'Play the Hangman game!'),
]

# Bbuttons with tooltips
